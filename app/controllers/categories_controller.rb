class CategoriesController < ApplicationController
  ...
  # The standalone Categories page was a read-only clone of the current
  # month's budget (SIMPLIFICATION_PLAN 1d) — management lives in Budgets.
  def index
    redirect_to budgets_path, status: :moved_permanently
  end
